...
<link rel="stylesheet" href="../streamPageCss/stream.css"/>
    ...
    <div class="infoAndUpNext">
        <section class="info">
            ...
            <div class="metadata">
                ...
                <span class="views">조회수 68,263회 최초 공개: 2021. 3. 15.</span>
            </div>
            <!-- Actions -->
            <ul class="actions">
                <li>
                    <button><i class="active fas fa-thumbs-up"></i><span>1.6천</span></button>
                </li>
                <li>
                    <button><i class="fas fa-thumbs-down"></i><span>65</span></button>
                </li>
                <li>
                ...
                <li>
                    <button><i class="fab fa-font-awesome-flag"></i><span>신고</span></button>
                </li>
            </ul>
            <!-- Channel Description -->
            <div class="channel">
