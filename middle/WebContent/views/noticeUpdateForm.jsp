...
<link rel="stylesheet" href="../boardCss/noticeUpdateBoard.css">
...
<body>
	...
	<section class="noticeUpdateSection">
	...
	<!-- 해당 글을 폼에 출력(title, contents) -->
		<form action="noticeUpdateAction.do" method="post">
			...
			<input class="notice_writer" type="text" name="notice_writer" value="${noticeBoard.notice_writer }"><br>
			<input class="notice_title" type="text" name="notice_title" value="${noticeBoard.notice_title }"><br>
			<br>
			<textarea rows="6" cols="70" name="notice_contents">${noticeBoard.notice_contents }</textarea>
			<br>
		<input class="genric-btn success circle" type="submit" value="수정완료">
		</form>
	</section>
</body>
</html>
