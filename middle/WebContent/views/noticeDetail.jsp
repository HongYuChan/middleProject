...
<link rel="stylesheet" href="../boardCss/noticeDetailBoard.css">
...
<body>
	...
	<section class="boardDetailSection">
		
		<div class="detailTitle">
			<div class="noticeId">글 번호</div>
			<div class="noticeTitle">제목</div>
			<div class="noticeDate">작성일</div>
			<div class="noticeWriter">작성자</div>
		</div>
		<div class="detailContents">
			<div class="noticeId">${noticeBoard.notice_id }</div>
			<div class="noticeTitle">${noticeBoard.notice_title }</div>
			<div class="noticeDate">${noticeBoard.notice_date }</div>
			<div class="noticeWriter">${noticeBoard.notice_writer }</div>
			<div class="noticeContents">${noticeBoard.notice_contents }</div>
		</div>
	
		
		<div class="footBtn">
			<a class="genric-btn success circle" href="noticeUpdateFormAction.do?notice_id=${noticeBoard.notice_id }">글수정</a>
			<a class="genric-btn primary circle arrow" href="noticeDeleteAction.do?notice_id=${noticeBoard.notice_id }">글삭제</a>
		</div>
